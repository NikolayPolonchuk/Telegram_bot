...
def game_over(X, Y, color):
    ...
    while True:
        ...
        if action == "restart":
            ...
            green_snake_body.append([60, 60])  # , [40, 60], [20, 60], [0, 60]]


            blue_snake_body.clear()
            blue_snake_body.append([600, 420])
            blue_snake_body.append([620, 420])
            blue_snake_body.append([640, 420])  # , [40, 420], [20, 420], [0, 420]]
...
while True:
    ...
    while not fruit_spawn:
        ...
        if not (
            fruit_position in green_snake_body or fruit_position in green_snake_body
        ):
            break
